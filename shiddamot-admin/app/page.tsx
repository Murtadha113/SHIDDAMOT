...
import { Upload, ListChecks, FolderTree, ArrowLeft, Package, BarChart3, FileDown, Sparkles, Image } from 'lucide-react'

const TILES = [
  { href: '/questions/add', icon: Upload, title: 'رفع الأسئلة', desc: 'ملف CSV/Excel أو إدخال يدوي', color: 'var(--blue)', bg: 'var(--blue-soft)' },
  { href: '/ai-generator', icon: Sparkles, title: 'مولّد الأسئلة الذكي', desc: 'توليد · يدوي · استخراج من نص بالـ AI', color: 'var(--blue)', bg: 'var(--blue-soft)' },
  ...
  { href: '/image-upload', icon: Image, title: 'رفع صورة', desc: 'ارفع صورة على imgBB واحصل على الرابط', color: 'var(--green-dark)', bg: 'var(--green-soft)' },
]
